  ...
  return(
    <Layout>
      <div className={styles.container}>
        <h1>About me</h1>
        <p>&emsp;{`Born and raised outside Abilene, Texas, my career began when I enlisted into the United States Marine Corps after high school. After training in California, I had one of the coolest jobs in the Marines: performing music for foreign dignitaries and presidential audiences at home and abroad.`}</p>
        ...
        <p>&emsp;{`During the last two weeks of General Assembly, I got a job offer and begun my career as a software engineer. Ever since then, it's been been full throttle ahead!`}</p>
      </div>
    </Layout>
  )
}